...
/**
 * @file      sat_final2_2.c
 * @author    Mustapha, Antony, Antoine
 * @version   2.2
 * @date      03-01-2019
 * @brief     SAT solver en C - Projet d'harmonisation . 
 */
...
/**
 * @brief Saisir le nombre de variables dans une clause par l'utilisateur
 * 
 * @param    nb_var          indique le nombre de variable / exemple: (a || b) donc 2 variables
 * @return nb_clause
 */
int condition1()
{
...
/**
 * @brief Saisir le nombre de clause par l'utilisateur
 * 
 * @param    nb_clause          indique le nombre de clause / exemple: exemple: (a || b) et (A || B) donc 2 clauses
 * @return   nb_clause
 */
int condition2()
{
...
/*
Fonction: Afficher le tableau de reference qui montre la liste de solutions en fonction des variables lorsqu'on a une clause a deux variables
variable: tab[5][4]  
*/

/**
 * @brief Afficher le tableau de reference qui montre la liste de solutions en fonction des variables lorsqu'on a une clause a deux variables
 * 
 * @param tab[5][4] 
 */
...
/*
Fonction: Afficher le tableau de reference qui montre la liste de solutions en fonction des variables lorsqu'on a une clause � 3 variables
variable: tab[10][6]  
*/

/**
 * @brief Afficher le tableau de reference qui montre la liste de solutions en fonction des variables lorsqu'on a une clause a 3 variables
 * 
 * @param tab[10][6]
 */
 ...
 * 
 * @param clause           une clause (liste clause)
 */
...
//////////////// CREATION DE LA LISTE : Allocation en memoire d'une clause ////////////////////:

/**
 * @brief        Creation de la liste : allocation en memoire d'une clause
 * @details      nouveau -> next=NULL : initialiser les valeurs suivantes a NULL pour que chaque pointeur pointe vers un rien
 * @param        valeur 
 * @return       nouveau 
 */
clause * creation(int valeur)
{
	...
	nouveau -> next=NULL; // initialiser les valeurs suivantes a NULL pour que chaque pointeur pointe vers un rien
	nouveau -> value=valeur;
	return nouveau ;
}

/*  Fonction Creation d'une clause compose de X variables  
variables : nb_var: nombre de variables dans la clause / clause *l = liste contenant clause/ clause * p: liste interm�diaire / valeur : variable dans la clause
*/

/**
 * @brief         Fonction Creation d'une clause compose de X variables  
 * 
 * @param         nb_var        nombre de variables dans la clause
 * @param         clause *l     liste contenant clause
 * @param         clause * p    liste intermediaire
 * @param         valeur        variable dans la clause
 * @return        1  
 */
...
/*
Tableau qui genere les solutions pour une clause a 2 variables (a b et B C )
*/

/**
 * @brief         Tableau qui genere les solutions pour une clause a 2 variables (a b et B C )  
 * 
 * @param         i, j     variables temporaires pour la boucle FOR
 */
...
/*
Tableau qui genere les solutions pour une clause a 3 variables (a b c et A B C )
*/

/**
 * @brief         Tableau qui genere les solutions pour une clause a 3 variables (a b c et A B C)  
 * 
 * @param         i, j     variables temporaires pour la boucle FOR
 */
...
/*
Fonction : Utilisant une clause a 2 variables. Elle compare la variable de la liste a celle du tableau de reference et introduit des valeurs
1 si vrai et 0 si faux . l'entier i indique la ligne ou l'on peut trouver une solution, donc si on 1 comme resultat apres comparaison
variables: clause / le tableau et i.
*/

/**
 * @brief			Fonction utilisant une clause a 2 variables. Elle compare la variable de la liste a celle du tableau de reference et introduit des valeurs 1 si vrai et 0 si faux.
 * 
 * @details			l'entier i indique la ligne ou l'on peut trouver une solution, donc si on a 1 comme resultat apres comparaison
 * @param			clause
 * @param			tab
 * @param			1
 */
...
/*
Fonction : Utilisant une clause a 3 variables. Elle compare la variable de la liste a celle du tableau de reference et introduit des valeurs
1 si vrai et 0 si faux . l'entier i indique la ligne ou l'on peut trouver une solution, donc si on 1 comme resultat apres comparaison
variables: clause / le tableau et i.
*/

/**
 * @brief			Fonction utilisant une clause a 3 variables. Elle compare la variable de la liste a celle du tableau de reference et introduit des valeurs 1 si vrai et 0 si faux.
 * 
 * @details			l'entier i indique la ligne ou l'on peut trouver une solution, donc si on a 1 comme resultat apres comparaison
 * @param			clause
 * @param			tab
...
{  	
		...
		for(cpt=0; cpt<nb_clause; cpt++)
		{
			affichage_liste(tab[cpt]);
		}
   		return 0;
}     
